...
using System.Text;
//using Sanxing.Share.Properties;
...
namespace Php
{
    ...
    public static partial class Win32
    {
        ...
        /// <returns></returns>
        public  static HDiskInfo GetHddInfoNT(byte driveIndex)
        {
            ...
            {
                CloseHandle(hDevice);
                //throw new IOException(string.Format(Resources.Win32_DeviceIoControlErr, "SMART_GET_VERSION"));
            }
            // 检测IDE控制命令是否支持
            if (0 == (vers.fCapabilities & 1))
            {
                CloseHandle(hDevice);
                //throw new IOException(Resources.Win32_DeviceIoControlNotSupport);
            }
                ...
                IntPtr.Zero))
            {
                ...
                //        string.Format(Resources.Win32_DeviceIoControlErr, "SMART_RCV_DRIVE_DATA"));
            }
            CloseHandle(hDevice);
